...
import 'package:develope_someting/video_qrscanner.dart';
import 'package:develope_someting/video_screen.dart';
...
class ProMode extends StatefulWidget {
  ...
  ProMode({Key? key, required this.cameras}) : super(key: key);
...
class _ProModeState extends State<ProMode> {
  ...
  List<double> exposureOffset = [-1.0, -0.5, 0.0, 0.5];
